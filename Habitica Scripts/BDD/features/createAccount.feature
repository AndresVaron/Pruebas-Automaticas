...
Scenario Outline: Crate account failed with wrong inputs
  ...
  Given I go to habitica home screen
    ...
    Examples:
      ...
      | pa_test9  | miso@gmail.com   | Prueba1  |             | "Password must be 8 characters or more."             |
      | pa_test9  | miso@gmail.com   | Prueba12 | Prueba13    | "Password confirmation doesn't match password."      |
      |           | miso@gmail.com   | Prueba12 | Prueba12    | "Missing username."                                  |
      | pa_test9  |                  | Prueba12 | Prueba12    | "Missing email."                                     |
      | pa_test9  | miso@gmail.com   |          |             | "Missing password."                                  |
...
Scenario Outline: Crate account success with right inputs
  ...
  Given I go to habitica home screen
    ...
    Examples:
      ...
      | pa_test2  | miso2@gmail.com   | Prueba12 | Prueba12    |