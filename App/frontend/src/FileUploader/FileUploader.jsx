...
const FileUploader = ({
    ...
    const uploadCurrentFile = (fileToUpload) => {
        uploadFile(filePath || 'uploads', uploadedFileName, fileToUpload)
            .then((data) => {
                setLoading(false);
            ...
            {!fileName && (
                <>
                    ...
                    <p className="small mb-0">
                        * El archivo será subido de forma automática
                    </p>
                </>
            )}
            {fileName && (
                <div className="input-group">
                    ...
                    <div className="input-group-append">
                        {!loading && !loadingSubmit && (
                            <span
                                className="input-group-text bg-danger text-white border-danger pointer"
                                onClick={removeFile}
                            >
