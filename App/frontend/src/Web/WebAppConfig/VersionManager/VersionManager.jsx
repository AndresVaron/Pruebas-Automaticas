...
const VersionsManager = ({
    ...
    return (
        <Modal setShowModal={setShowModal} loading={loading}>
                ...
                <div className="row d-flex align-items-center">
                    ...
                    <div className="col-7 text-right">
                        <p className="small mb-0 font-weight-bold">
                            <em className="fas fa-calendar text-info"></em>
                            &nbsp;{getFormattedDate(version.creationDate)}
                        </p>
                    </div>
                </div>
            ))}
            <hr />
            <h1 className="content-title">
                Crear {type !== 'MobileMonkey' ? 'versión' : ''}
            </h1>
            <form onSubmit={handleSubmit}>
                {type !== 'MobileMonkey' && (
                    <>
                        <div className="d-flex align-items-center mt-3">
                            <label className="mb-0 mr-3 font-weight-bold">
                                Versión:
                            </label>
                            <input
                                name="version"
                        ...
                        <div className="mt-3">
                            ...
                            <FileUploader
                                loadingSubmit={loading || !form.version}
                                currentFileName={''}
